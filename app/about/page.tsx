    ...
    <div className="flex flex-col justify-center items-center h-screen">
      <Card className="max-w-2xl">
        ...
        <CardContent className="space-y-4">
          <p>
            Welcome to Wordsta, an innovative word-learning application designed to enhance your English vocabulary.
          </p>
          <p>
            Our goal is to help you improve your language skills efficiently, whether you're preparing for standardized tests like GRE or TOEFL, or simply aiming to expand your lexicon.
          </p>
          <h3 className="text-xl font-semibold mt-6">Key Features</h3>
          <ul className="list-disc list-inside">
            <li>Interactive word swiping for engaging learning</li>
            <li>Multiple word lists catering to various needs (GRE, TOEFL, etc.)</li>
          ...
          <p className="text-sm mt-6">
            Expand your vocabulary, enhance your communication skills, and unlock new opportunities with Wordsta.
          </p>
        </CardContent>
      </Card>
      <p className="text-sm mt-6">
